# FlowLiDAR Prototype 4 — table setup
# Adds IPv4 LPM entry + conditional BF/CMS table entries for lazy BF.
# Run with: bfshell> bfrt_python /home/student/Desktop/flowlidar/prototype4/setup_table.py
...
# CMS only fires when all 3 BF bits were already 1 (known flow).
