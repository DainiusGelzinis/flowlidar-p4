# FlowLiDAR Prototype 8 — epoch reset (Traditional BF baseline, 131072 cells/array)
# Clears all BF and CMS register arrays to start a new measurement epoch.
# Run with: bfshell> bfrt_python /home/student/Desktop/flowlidar/prototype8/reset_epoch.py
