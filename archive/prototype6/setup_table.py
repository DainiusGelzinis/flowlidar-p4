# FlowLiDAR Prototype 6 — table setup
# Same conditional tables as prototype5 plus the new master_hash table.
...
#
# Run with: bfshell> bfrt_python ~/dainius/prototype6/setup_table.py
