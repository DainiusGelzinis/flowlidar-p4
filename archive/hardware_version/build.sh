#!/usr/bin/env bash
# =============================================================================
# build.sh — Build script for FlowLiDAR hardware_version (real Tofino 1)
...
echo "============================================================"
echo "  Building FlowLiDAR (hardware_version)"
echo "  SDE         : $SDE"
...
echo "    bfrt_python ~/hardware_version/setup_table.py"
echo ""
echo "  Then run control plane (terminal 2):"
echo "    python3 ~/hardware_version/control_plane.py --epoch 30"
echo ""
echo "  Then send packets FROM hotpot (separate machine):"
echo "    sudo python3 ~/hardware_version/test_packet.py"
echo "============================================================"
