# FlowLiDAR hardware_version — table setup
# For real Tofino 1 hardware (p4switch2).
#   Ingress: port 1/0 (D_P=132) — hotpot enp172s0f0np0 connects here
#   Egress:  port 2/0 (D_P=140) — hotpot enp172s0f1np1 connects here
#
# Run with: bfshell> bfrt_python ~/hardware_version/setup_table.py

p4 = bfrt.prototype5.pipe

# --- Enable ports ---
# Port 2/0 (D_P=140): ingress from hotpot enp172s0f0np0
# Port 1/0 (D_P=132): egress back to hotpot enp172s0f1np1
bfrt.port.port.add(DEV_PORT=132, SPEED='BF_SPEED_40G', FEC='BF_FEC_TYP_FIRECODE', PORT_ENABLE=True)
bfrt.port.port.add(DEV_PORT=140, SPEED='BF_SPEED_40G', FEC='BF_FEC_TYP_FIRECODE', PORT_ENABLE=True)
print("Ports enabled: 1/0 (D_P=132) and 2/0 (D_P=140)")

# --- IPv4 LPM forwarding ---
# Packets to 10.0.0.1 enter on port 1/0 and exit on port 2/0 (D_P=140)
