#!/usr/bin/env python3
"""
FlowLiDAR hardware_version2 — Control Plane (Sub-sketch / Sketchlet partitioning)
...
# ---------------------------------------------------------------------------
# CRC functions (polynomials must match prototype6.p4 exactly)
# ---------------------------------------------------------------------------
if HAS_CRCMOD:
...
def main():
    parser = argparse.ArgumentParser(
        description='FlowLiDAR hardware_version2 — Control Plane (Sub-sketch solver)')
    ...
    print('=' * 72)
    print('  FlowLiDAR hardware_version2 — Control Plane (Sub-sketch solver)')
