# FlowLiDAR Prototype 7 — table setup
# Same as prototype6 (sub-sketch CMS) but with the BF doubled to 262144 cells
# per array. Conditional BF/CMS tables and master_hash table unchanged.
...
#
# Run with: bfshell> bfrt_python ~/dainius/prototype7/setup_table.py
