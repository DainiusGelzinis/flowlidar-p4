# FlowLiDAR cpp_lazy_bf524k_cms256x1024 — table setup for lazy_bf524k_cms256x1024.
# For real Tofino 1 hardware (p4switch2). 64 sub-sketches × 2048 cols × 16 bit.
#   Ingress: port 2/0 (D_P=140) — hotpot enp172s0f0np0 connects here
#   Egress:  port 1/0 (D_P=132) — hotpot enp172s0f1np1
#
# Run with: bfshell> bfrt_python /home/onie/dainius/cpp_lazy_bf524k_cms256x1024/setup_table.py

p4 = bfrt.lazy_bf524k_cms256x1024.pipe
...
# --- Conditional CMS increment tables (sub-sketch CMS, 64×2048) ---
