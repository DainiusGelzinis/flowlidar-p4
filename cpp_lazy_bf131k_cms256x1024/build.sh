#!/usr/bin/env bash
# =============================================================================
# build.sh — Build script for cpp_lazy_bf131k_cms256x1024
# Run this on p4switch2, not on the local VM.
# =============================================================================

set -euo pipefail

PROGRAM_NAME="lazy_bf131k_cms256x1024"
P4_FILE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lazy_bf131k_cms256x1024.p4"
...
echo "    bfrt_python ~/dainius/cpp_lazy_bf131k_cms256x1024/setup_table.py"
echo ""
echo "  Then run C++ control plane (terminal 2):"
echo "    ~/dainius/cpp_lazy_bf131k_cms256x1024/lazy_bf131k_cms256x1024_cp \\"
