 ...
 *   BF  : 3 × 131072 × 1 bit   (bit<20> index, k=3, lazy chain)
 ...
 *
 * Index widths:
 *   - BF register index : bit<20>  (131072 cells)
...
struct metadata_t {
    ...
    // BF hash indices — 20-bit each (131072 cells per row).
    bit<17> idx0;
    bit<17> idx1;
    bit<17> idx2;
...
control SwitchIngress(
    ...
    // =========================================================================
    // BLOOM FILTER — Lazy Updates, 3 × 131072 cells (1 Mbit each)
    // =========================================================================
