#!/usr/bin/env bash
# =============================================================================
# build.sh — Build script for cpp_lazy_bf262k_cms64x2048
# Run this on p4switch2, not on the local VM.
# =============================================================================

set -euo pipefail

PROGRAM_NAME="lazy_bf262k_cms2048"
P4_FILE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lazy_bf262k_cms2048.p4"
...
echo "    bfrt_python ~/dainius/cpp_lazy_bf262k_cms64x2048/setup_table.py"
echo ""
echo "  Then run C++ control plane (terminal 2):"
echo "    ~/dainius/cpp_lazy_bf262k_cms64x2048/lazy_bf262k_cms2048_cp \\"
