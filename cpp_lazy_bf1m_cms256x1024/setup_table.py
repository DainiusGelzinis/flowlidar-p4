# FlowLiDAR cpp_lazy_bf1m_cms256x1024 — table setup for lazy_bf1m_cms256x1024.
...
#
# Run with: bfshell> bfrt_python /home/onie/dainius/cpp_lazy_bf1m_cms256x1024/setup_table.py

p4 = bfrt.lazy_bf1m_cms256x1024.pipe
