#!/usr/bin/env python3
"""
print_ids.py — print bfrt table IDs for the 6 lazy_bf2m_cms256x1024 register tables.
...
Usage on the switch:
    python3 /home/onie/dainius/cpp_lazy_bf2m_cms256x1024/print_ids.py
"""
...
print()
print('Pass these to lazy_bf2m_cms256x1024_cp:')
