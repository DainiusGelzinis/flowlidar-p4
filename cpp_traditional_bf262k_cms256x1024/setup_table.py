# FlowLiDAR cpp_traditional_bf262k_cms256x1024 — table setup.
...
#
# Run with: bfshell> bfrt_python ~/dainius/cpp_traditional_bf262k_cms256x1024/setup_table.py

p4 = bfrt.traditional_bf262k_cms256x1024.pipe
