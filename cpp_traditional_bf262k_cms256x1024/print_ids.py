...
Usage on the switch:
    python3 ~/dainius/cpp_traditional_bf262k_cms256x1024/print_ids.py
"""
...
P4_NAME = 'traditional_bf262k_cms256x1024'
...
print()
print('Pass these to traditional_bf262k_cms256x1024_cp:')
