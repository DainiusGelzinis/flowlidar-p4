...
control SwitchIngress(
    ...
    // & 18w0x3F000 (bits [17:10] = bucket_id << 10).
    // =========================================================================
    ...
    action compute_master_offset() {
        ig_md.sketchlet_offset = master_hash_fn.get(
            {hdr.ipv4.src_addr, hdr.ipv4.dst_addr,
             hdr.ipv4.protocol,
             ig_md.src_port, ig_md.dst_port}) & 18w0x3F000;
    }
    ...
    Hash<bit<12>>(HashAlgorithm_t.CUSTOM, cms_poly0) cms_hash0;

    CRCPolynomial<bit<32>>(32w0x814141AB,
                           false, false, false,
                           32w0x00000000, 32w0x00000000) cms_poly1;
    Hash<bit<12>>(HashAlgorithm_t.CUSTOM, cms_poly1) cms_hash1;

    CRCPolynomial<bit<32>>(32w0x04C11DB7,
                           false, false, false,
                           32w0x00000000, 32w0xFFFFFFFF) cms_poly2;
    Hash<bit<12>>(HashAlgorithm_t.CUSTOM, cms_poly2) cms_hash2;
