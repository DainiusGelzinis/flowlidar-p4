# FlowLiDAR cpp_lazy_bf1m_cms64x4096 — table setup for lazy_bf1m_cms256x1024.
...
#
# Run with: bfshell> bfrt_python /home/onie/dainius/cpp_lazy_bf1m_cms64x4096/setup_table.py

p4 = bfrt.lazy_bf1m_cms64x4096.pipe
