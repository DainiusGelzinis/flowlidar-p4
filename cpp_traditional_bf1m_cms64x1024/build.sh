#!/usr/bin/env bash
# =============================================================================
# build.sh — Build script for cpp_traditional_bf1m_cms64x1024
# Run this on p4switch2, not on the local VM.
# =============================================================================

set -euo pipefail

PROGRAM_NAME="traditional_bf1m_cms64x1024"
P4_FILE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/traditional_bf1m_cms64x1024.p4"
...
echo "    bfrt_python ~/dainius/cpp_traditional_bf1m_cms64x1024/setup_table.py"
echo ""
echo "  Then run C++ control plane (terminal 2):"
echo "    ~/dainius/cpp_traditional_bf1m_cms64x1024/traditional_bf1m_cms64x1024_cp \\"
