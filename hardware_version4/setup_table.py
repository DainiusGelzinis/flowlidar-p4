# FlowLiDAR hardware_version4 — table setup for prototype8 (traditional BF).
...
#
# tbl_bf1 / tbl_bf2 are now keyless (always-run) so no entries are needed.
# CMS gate entries (1,1,1) stay the same as in hardware_version3.
#
# Run with: bfshell> bfrt_python ~/dainius/hardware_version4/setup_table.py
...
# CMS still only fires when (b0,b1,b2) = (1,1,1).
