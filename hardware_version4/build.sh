#!/usr/bin/env bash
# =============================================================================
# build.sh — Build script for FlowLiDAR hardware_version4 (real Tofino 1)
# Run this on p4switch2, not on the local VM.
# =============================================================================

set -euo pipefail

PROGRAM_NAME="prototype8"
P4_FILE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/prototype8.p4"
...
echo "============================================================"
echo "  Building FlowLiDAR Prototype 8 (hardware_version4 — Traditional BF baseline)"
echo "  SDE         : $SDE"
...
echo "    bfrt_python ~/dainius/hardware_version4/setup_table.py"
echo ""
echo "  Then run control plane (terminal 2):"
echo "    python3 ~/dainius/hardware_version4/control_plane.py --epoch 30"
echo ""
