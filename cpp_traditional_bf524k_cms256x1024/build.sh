...
echo "    bfrt_python ~/dainius/cpp_traditional_bf524k_cms256x1024/setup_table.py"
echo ""
echo "  Then run C++ control plane (terminal 2):"
echo "    ~/dainius/cpp_traditional_bf524k_cms256x1024/traditional_bf524k_cms256x1024_cp \\"
