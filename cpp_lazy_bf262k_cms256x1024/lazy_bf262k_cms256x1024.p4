 ...
 *   BF  : 3 × 262144 × 1 bit   (bit<20> index, k=3, lazy chain)
 ...
 *
 * Index widths:
 *   - BF register index : bit<20>  (262144 cells)
...
struct metadata_t {
    ...
    // BF hash indices — 20-bit each (262144 cells per row).
    bit<18> idx0;
    bit<18> idx1;
    bit<18> idx2;
...
control SwitchIngress(
    ...
    // =========================================================================
    // BLOOM FILTER — Lazy Updates, 3 × 262144 cells (1 Mbit each)
    // =========================================================================
