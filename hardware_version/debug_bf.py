#!/usr/bin/env python3
"""
FlowLiDAR hardware_version — BF Hash Debug Script
Run this on p4switch2 (real hardware).
...
# SDE path for p4switch2 (SDE 9.11.0, Python 3.10)
SDE_INSTALL = os.environ.get('SDE_INSTALL',
                             '/home/onie/sde/bf-sde-9.11.0/install')
sys.path.append(os.path.join(SDE_INSTALL, 'lib/python3.10/site-packages'))
sys.path.append(os.path.join(SDE_INSTALL, 'lib/python3.10/site-packages/tofino'))
