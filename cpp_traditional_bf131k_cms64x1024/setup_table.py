# FlowLiDAR cpp_traditional_bf131k_cms64x1024 — table setup.
...
#
# Run with: bfshell> bfrt_python ~/dainius/cpp_traditional_bf131k_cms64x1024/setup_table.py

p4 = bfrt.traditional_bf.pipe
