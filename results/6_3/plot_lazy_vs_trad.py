#!/usr/bin/env python3
"""Render lazy vs traditional BF line charts from summary_chunk0.csv.
...
# Keep the most recent row per variant (overwrites stale 5Gbps lazy_bf2m).
rows = {}
with open(SRC) as f:
...
for col, ylabel, fname in PLOTS:
    ...
    ax.plot(trad[0], trad[col], marker="s", label="Traditional BF", color="#d62728")
